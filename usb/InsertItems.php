...
class InsertItems{
	...
	if (isset($_POST["nomeFuncionario"]) && isset($_POST["unidade"]) && isset($_POST["nomePlaca"]) && isset($_POST["viatura"])
		...
		$this ->insert($nomeFuncionario, $unidade, $nomePlaca, $nomeKM, $nomeCargo, $viatura, $qtdA, $qtdE, $qtdM, $qtdMedic);
...
private function insert($nF, $nU, $nP, $nK, $nC, $nV, $qtdA, $qtdE, $qtdM, $qtdMedic) {
	...
	try {
		...
		$insert = "INSERT INTO checklist(unidade,nomeFuncionario,viatura,nomePlaca,nomeKm,nomeCargo,acessorios,equipamentos,materiais,medicacao,datac)".
"VALUES(:unidade,:nomeFuncionario,:viatura,:nomePlaca,:nomeKm,:nomeCargo,:acessorios,:equipamentos,:materiais,:medicacao,:data)";
