...
if($_SESSION["acess"] != "usb"){
	header("Location:../");
}

include_once("SelectUsb.php");
            ...
            <div class="caixa1">
                   ...
                   <!-- ACESSÓRIOS -->
						...
						foreach($acessorios as $value => $key){
							...
							<tr>
								...
								<td><input id='acessorios[]' name='acessorios[]' required=required   type='text' multiple='multiple'></td>
						...
						foreach($medicamentos as $value => $key){	
							echo "
							<tr>
								<td id='nomeMedicamento'>$key[2]</td>
								<td>$key[3]</td>
                ...
                <div class="div4">
					...
					<div class="boxinput">
						...
						<div class="dsinput">
							<span>Unidade:</span>
							<td><select id="estados" name="unidade"><option disabled selected value>Escolha...</option></select></td>
						</div>
						<div class="dsinput">
						<span>VTR:</span>
							<td><select id="cidade" name="viatura"><option disabled selected value>Escolha...</option></select></td>
						</div>
						<div class="dsinput">
						<span>KM:</span>
						...
						<input type='submit' class="inpthover" onclick='sendForm()'>
						</div>
					</div>
...
<script>
	...
	var cidades = {
	"BELFORD ROXO": ["USB 1","USB 2"],
	"DUQUE DE CAXIAS": ["USB 1","USB 2","USB 3","USB 4","USB 5","USB 6","USB 7","USB 8"],
	"ITAGUAI": ["USB 1"],
	"JAPERI": ["USB 1"],
	"MAGE": ["USB 1","USB 2"],
	"MESQUITA": ["USB 1","USB 2"],
	"NILOPOLIS": ["USB 1"],
	"NOVA IGUACU": ["USB 1", "USB 2", "USB 3", "USB 4", "USB 5", "USB 6", "USB 7", "USB 8"],
	"PARACAMBI": ["USB 1"],
	"QUEIMADOS": ["USB 1","USB 2"],
	"SAO JOAO DE MERITI": ["USB 1","USB 2","USB 3","USB 4","USB 5"],
	"SEROPEDICA": ["USB 1","USB 2"],
	};
