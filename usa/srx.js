...
function hideAll() {
	...
	equipamentos.style.display = "none";
	materiais.style.display = "none";
	medicamentoalto.style.display = "none";
...
function checkTables(){
	...
	for(var i of listMedicamento){		
		if(i.value == "" || i.value == null){			
			document.getElementsByClassName("btnc")[4].style.backgroundColor = "red";
			break;
		}else{
			document.getElementsByClassName("btnc")[4].style.backgroundColor = "#00FF00";
		}
	}
...
function sendForm() {
	...
	formu.addEventListener("submit", checkSend());
...
function send(event) {
	...
	(function () {
		var nomeMedAlta = document.querySelectorAll("td[id='medAlta']");
		var listMedAlta = document.querySelectorAll("input[id='medAlta[]']");
		var a = 0;
		var b = 0;


		for (var i of nomeMedAlta) {
			document.querySelectorAll("input[id='medicacaoAlta']")[a++].value = i.innerHTML + '=' + listMedAlta[b++].value;
	...
	(function () {
		var nomeMedicamento = document.querySelectorAll("td[id='medicamento']");
		var listMedicamento = document.querySelectorAll("input[id='medicamento[]']");
		var a = 0;
		var b = 0;
